/**
 * EFF short wordlist #1 (1296 words), used for the five-word recovery tickets.
 *
 * From the Electronic Frontier Foundation, https://www.eff.org/dice
 * Licensed CC BY 4.0: https://creativecommons.org/licenses/by/4.0/
 * Reformatted from tab-separated dice rolls; the words are unchanged.
