...
export { bluff, draw3, draw5, holdem, omaha, pineapple, stud5, stud7, three };
...
export function registerBuiltinVariants(): void {
  for (const v of [holdem, omaha, pineapple, stud7, stud5, draw5, three, draw3, bluff]) registerVariant(v);
}
